...
// PATCH /api/student/notifications/mark-all-read - Mark all notifications as read
export async function PATCH(request) {
  try {
    ...
    notifications.forEach(notification => {
      if ((notification.userId === user.id || notification.userId === 'student123') && !notification.isRead) {
